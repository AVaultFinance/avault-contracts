...
async function main() {
  ...
  const AVaultPCS = await AVaultPCSContract.deploy(["0x456C0082DE0048EE883881fF61341177FA1FEF40", farmContractAddress, kacRouterAddress, kacRouterAddress, timelock.address], 
    1, false, [kac, wsdn], 
    [wsdn, kac],
    [kac], [kac, wsdn],
    [kac], [wsdn, kac],
    "KAC-WSDN ckLP", "ckLP-KW");
